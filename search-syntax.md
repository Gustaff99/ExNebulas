...
exNebulas comes with a search syntax by with you can modify the categories,
...
exNebulas supports the external bangs from [DuckDuckGo].  To directly jump to a
...
engine, exNebulas cannot protect your privacy on this.
